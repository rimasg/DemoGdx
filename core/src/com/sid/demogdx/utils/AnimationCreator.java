...
public final class AnimationCreator {
	 ...
	 * 
	 * */
	public static Animation<TextureRegion> getAnimationFromMultiTextures(
	 ...
	 * 
	 * */
	public static Animation<TextureRegion> getAnimationFromSingleTexture(
		...
		for (int i = 0; i < numberOfFrames; i++) {
			keyFrames[i] = new TextureRegion(textureRegion,
					(textureRegion.getRegionWidth() / numberOfFrames) * i,
					0,
	 ...
	 * 
	 * */
	public static Animation<TextureRegion> getAnimationFromSingleTextureMultiRows(
			TextureAtlas textureAtlas, String animationName,
			int numberOfFrames, int numberOfRows, int indexOfAnimationRow, float frameDuration) {
		// Get animation texture (single texture)
		TextureRegion textureRegion = textureAtlas.findRegion(animationName);
		// Key frames list
		TextureRegion[] keyFrames = new TextureRegion[numberOfFrames];
		...
		for (int i = 0; i < numberOfFrames; i++) {
			keyFrames[i] = new TextureRegion(
					textureRegion,
					(textureRegion.getRegionWidth() / numberOfFrames) * i,
					(textureRegion.getRegionHeight() / numberOfRows) * indexOfAnimationRow,
					textureRegion.getRegionWidth() / numberOfFrames,
